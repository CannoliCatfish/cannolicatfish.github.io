    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl: 'https://github.com/CannoliCatfish/cannolicatfish.github.io',
        },
        blog: {
          showReadingTime: true,
          // Please change this to your repo.
          editUrl:
            'https://github.com/CannoliCatfish/cannolicatfish.github.io',
        },
        theme: {
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Project Rankine Development Team. Built with Docusaurus.`,
      },
      prism: {
